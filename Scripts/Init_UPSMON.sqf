...
KRON_UPS_Res_enemy = [east]; //dependent on mission settings! ToDo: make this param auto sensing
...
KRON_UPS_closeenough = 300;  // ToDo investigate effect of decrease of this value to e.g. 50
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------			
	...
	UPSMON_Version = "UPSMON 5.2.0 beta1";
	...
	KRON_UPS_Instances=-1; //ToDo verify usage of this parameter
	KRON_UPS_Total=0;
	KRON_UPS_Exited=0;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	if (isNil("KRON_UPS_INIT") || KRON_UPS_INIT == 0) then {
		...
		// Decleration Of Private Variables
	...
	// Set KRON_fnc_setVehicleInit. Replaces setVehicleInit. Moved to functions definition file.			
